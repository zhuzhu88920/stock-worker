...
|------|----------|------|------|------|----------|
| A股基金 | - | - | - | - | 净值更新: 19:00-21:00 |
| 港股 | 09:00-09:30 | 09:30 | 16:00 | - | - |
| 韩股 | - | 09:00 | 15:30 | 15:30-16:00 | - |
| 美股 | 21:30-22:30 | 22:30 | 05:00(次日) | 05:00-08:00 | 夏令时/冬令时自动切换 |
...
# 标题模板
[title]
template = "{market_status}   📅 {date}  ⏰ {time}"
...
- **配置存储**：使用 Cloudflare KV 存储配置文件
- **数据存储**：使用 Cloudflare KV 存储历史数据
